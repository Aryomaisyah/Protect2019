...
oepoll = OEPoll(cl)
call = cl
creator = ["u4a94996d4d7e713a1d8debb13d286728"]
owner = ["u4a94996d4d7e713a1d8debb13d286728"]
admin = ["u4a94996d4d7e713a1d8debb13d286728"]
staff = ["u4a94996d4d7e713a1d8debb13d286728"]
...
def help():
    ...
    num = (num+1)
    helpMessage += "╠☙⊷⋗ %i. " % num + key + "Sopo @\n"
    num = (num+1)
    helpMessage += "╠☙⊷⋗ %i. " % num + key + "Respon\n"
    num = (num+1)   
    helpMessage += "╠☙⊷⋗ %i. " % num + key + "Responname\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "╠☙⊷⋗ %i. " % num + key + "Sider/off\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage += "╠☙⊷⋗ %i. " % num + key + "Srespon: text\n"
    num = (num+1)
    ...
    num = (num+1)    
    helpMessage += "┃ " + "     ─¤ = ~~ ~= ◉=~ ~~ = ¤─\n"
    helpMessage += "┃ " + "  ━❰･ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ･❱━\n"
    helpMessage += "╰━━━━━━━━━━━━━━━━\n"
    helpMessage += "    ◉ᴊʜᴀɪʟʙ❍ᴛs ᴘʀ❍ᴛᴇᴄᴛ ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ\n"
    return helpMessage
...
def helpbot():
    ...
    num = (num+1)    
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "!jk「in」\n"
    num = (num+1)  
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "!jk「lv」\n"
    num = (num+1)    
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "Infogrup「angka」\n"
    num = (num+1)
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "Infomem「angka」\n"
    num = (num+1)     
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "!jk [kickall]\n"
    num = (num+1)
    helpMessage2 += "╠☙⊷⋗ %i. " % num + key + "Nuke [kickall]\n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage2 += "┃ " + "├────────────\n"
    helpMessage2 += "┃ " + "  ━❰･ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ･❱━\n"
    helpMessage2 += "╰━━━━━━━━━━━━━━━━\n"
    helpMessage2 += "    ◉ᴊʜᴀɪʟʙ❍ᴛs ᴘʀ❍ᴛᴇᴄᴛ ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ\n"
    return helpMessage2
...
def helpbot1():
    ...
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Addvid •nama• \n"
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Dellvideo •nama• \n"
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Listvideo •nama• \n"
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Addstick •nama• \n"
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Dellstick •nama• \n"
    num = (num+1)
    helpMessage3 += "╠☙⊷⋗ %i. " % num + key + "Liststick •nama• \n"
    num = (num+1)
    ...
    num = (num+1)
    helpMessage3 += "┃ " + "   ─¤ = ~~ ~= ◉=~ ~~ = ¤─\n"
    helpMessage3 += "┃ " + "  ━❰･ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ･❱━\n"
    helpMessage3 += "╰━━━━━━━━━━━━━━━━\n"
    helpMessage3 += "    ◉ᴊʜᴀɪʟʙ❍ᴛs ᴘʀ❍ᴛᴇᴄᴛ ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ\n"
    return helpMessage3
...
def helpbot2():
    ...
    key = key.title()
    helpMessage4 = "╭━━━━━━━━━━━━━━━━\n"
    helpMessage4 += "┃ " + "  ━❰･ᴊʜᴀɪʟʙ❍ᴛs pя❍тεcт･❱━\n"
    helpMessage4 += "┃" + "   ━━━━❰･sєτкєy･❱━━━━\n"
    helpMessage4 += "┃" + "─────────────\n"
    ...
    num = (num+1)
    helpMessage4 += "╠☙⊷⋗ %i. " % num + key + "Stamina\n"
    num = (num+1)
    helpMessage4 += "┃ " + "   ─¤ = ~~ ~= ◉=~ ~~ = ¤─\n"
    helpMessage4 += "┃ " + "  ━❰･ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ･❱━\n"
    helpMessage4 += "╰━━━━━━━━━━━━━━━━\n"
    helpMessage4 += "    ◉ᴊʜᴀɪʟʙ❍ᴛs ᴘʀ❍ᴛᴇᴄᴛ ᴛᴇᴀᴍ sɪʟᴇɴᴛ ᴋɪʟʟᴇʀ\n"
    return helpMessage4
...
#=====================================================================================================================================
                        elif ".dteam6 " in msg.text:
                            if msg._from in Juns:
                                userx = msg.text.replace('.dteam6 ','')
                                os.system('screen -S {} -X quit'.format(userx))
                                time.sleep(2)
                                client.sendMessage(to, "Succes Logout User {}".format(userx))
#=====================================================================================================================================
                        elif ".team6: " in msg.text:
                            if msg._from in Juns:
                                userx = msg.text.replace('.team6: ','')
                                os.system('screen -dmS {}'.format(userx))
                                os.system('screen -r {} -X stuff "cd p5 && python3 x6.py\n"'.format(userx))
                                time.sleep(3)
                                client.sendMessage(to, "Succes login user to {}".format(userx))             
#=====================================================================================================================================                                                
                        elif cmd == "status":
                          if wait["selfbot"] == True:
                            if msg._from in owner or msg._from in admin:
...
#====================================================================                            
                         ...
                         if msg._from in admin:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ki.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               kk.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               kc.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               km.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               kb.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               sw.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                               dz.sendMessage(msg.to, "۞𝔖𝔢𝔩𝔣𝔟𝔬𝔱 𝔨𝔦𝔩𝔩𝔢𝔯 𝔡𝔞𝔫 𝔭𝔯𝔬𝔱𝔢𝔠𝔱 𝔣𝔬𝔯  𝔤𝔯𝔬𝔲𝔭 𝔩𝔦𝔫𝔢 ➤")
                          ...
                          if wait["selfbot"] == True:
                           ...
                           if msg._from in owner or msg._from in admin or msg._from in staff:
                           	if msg.toType == 2:
                                  ...
                                  cl.sendMessage(msg.to, "「 Jhail of silentkiller 」\nmember : " +str(len(ginfo.members)) + " \nFuck you...")
                                  G = cl.getGroup(msg.to)
                                  G.preventedJoinByTicket = False
                                  cl.updateGroup(G)
                                  Ticket = cl.reissueGroupTicket(msg.to)
